...
int main(int argc, char* argv[]) {
  ...
  try {
    ...
    std::cout << "========================================\n";
    std::cout << "  ONNX Streaming Inference\n";
    std::cout << "========================================\n";
    ...
    auto g2p = std::make_shared<GPTSoVITS::G2P::G2PPipline>();
    {
      ...
      bert->Init<GPTSoVITS::Model::ONNXBackend>(
